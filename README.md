Bootstrap assignment (assignment 3) // challenge 3

Weds - Challenge - only do one of them in the speed runs. E.g. Level 1 or 2. Level 3 is the challenging one.
Choose Level 1 and just use any old pics. He used corgis.

You don’t have to push every time you commit. 

Git add .
Git commit -m “save point”
Git add . 
Git commit -m “added pagination to top of page”
THEN PUSH.

Bootstrap-portfolio. You can copy over the challenge 2 portfolio.
...
Footer with hyperlinks to GitHub and LinkedIn
￼
‘Go full page’  screenshot

Typed JS - use typed JS to use typed out animation. https://github.com/mattboldt/typed.js/
￼
Make this ￼
It’s just vanilla bootstrap
Copy it from the solved California Travel one 

There is always a YouTube. The first thing you do is YouTube search it. 

Laura’s has react animations 

Use day 3 exercise Travel California for it

Set visibility of text to be invisible… 

https://github.com/mattboldt/typed.js/

youtube for typed effect javascript portfolio site
